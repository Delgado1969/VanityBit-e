...
class VanityAddressGenerator:
    ...
    def __init__(self, root):
        ...
        self.input_label = tk.Label(root, text="Enter the first string of the desired address:", font=font_medium)
        self.input_label.pack(padx=20, pady=5)

        self.entry = tk.Entry(root, font=font_medium)
        self.entry.pack(padx=20, pady=5)

        self.thread_label = tk.Label(root, text="Enter the number of threads to use:", font=font_medium)
        ...
        self.generate_button = tk.Button(root, text="Build starts", command=self.start_generation, bg='#4CAF50', fg='white', font=font_medium)
        self.generate_button.pack(padx=20, pady=10)

        self.address_label = tk.Label(root, text="Generated vanity address:", font=font_medium)
        ...
        self.private_key_label = tk.Label(root, text="Private key (WIF):", font=font_medium)
        ...
        self.hashrate_label = tk.Label(root, text="Hash rate (attempts/sec):", font=font_medium)
    ...
    def start_generation(self):
        try:
            ...
            if thread_count > max_threads:
                tk.messagebox.showerror("Error", f"The maximum number of threads on a PC is {max_threads} Please enter a number less than this.")
                return
            ...
            tk.messagebox.showerror("Error", "Invalid number of threads. Please enter a valid number.")
